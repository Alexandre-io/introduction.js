...
(function(root, factory) {
  ...
  function _introForElement(targetElm) {
    ...
    if (this._options.steps) {
      ...
      var nextStep = 0;
      for (var k = 0; k < elmsLength; k++) {
        var currentEl = allIntroSteps[k];
  ...
  function _showElement(targetElement) {
    var skipTooltipButton, prevTooltipButton, nextTooltipButton, helperNumberLayer;
    ...
    if (oldHelperLayer !== null) {
      ...
      for (var l = 0, stepsLength = this._introItems.length; l < stepsLength; l++) {
        ...
        anchorLink.setAttribute('data-stepnumber', this._introItems[l].step);
      ...
      nextTooltipButton.href = 'javascript:void(0);'; // jshint ignore:line
      ...
      prevTooltipButton.href = 'javascript:void(0);'; // jshint ignore:line
      ...
      if (this._options.showSkipButton) {
        ...
        skipTooltipButton.href = 'javascript:void(0);'; // jshint ignore:line
  ...
  exports.introductionjs = introJs;
  return introJs;
}));
